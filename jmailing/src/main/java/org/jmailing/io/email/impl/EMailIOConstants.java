...
public interface EMailIOConstants {
	static public final String ATTACHMENT_FILENAME = "attachment.filename";
	static public final String ATTACHMENT_NAME = "attachment.name";
